    ...
    public class ConfigurationTest
    {
        ...
        {            
            var u = new Map
            {
                Configuration = new cfg(new CompositeProvider(new IResourceProvider[]
                {
                    new InMemoryProvider(new UriStringToSettingIdentifierConverter(), new SoftString[] { "setting" }, ImmutableSession.Empty.Set(Use<IProviderSession>.Namespace,x => x.CustomName, "OtherOne"))
                    {
                        { "Map.City", "Joe" }
                    },
                    new InMemoryProvider(new UriStringToSettingIdentifierConverter(), new SoftString[] { "setting" })
                    ...
                    new InMemoryProvider(new UriStringToSettingIdentifierConverter(), new SoftString[] { "setting" }, ImmutableSession.Empty.Set(Use<IProviderSession>.Namespace,x => x.CustomName, "ThisOne"))
                    {
                        { "Map.City", "Bob" }
                    },
                }))
