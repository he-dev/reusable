...
namespace Reusable.Shelly
{
    internal class CommandFactory
    {
        ...
        public Command CreateCommand(CommandInfo commandInfo, IEnumerable<IGrouping<string, string>> arguments)
        {
            Debug.Assert(commandInfo != null);
            Debug.Assert(arguments != null);

            var command = (Command)Activator.CreateInstance(commandInfo.CommandType, commandInfo.Args);
