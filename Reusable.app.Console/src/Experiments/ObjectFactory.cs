...
public static class ObjectFactory
{
    ...
    private static Type BuildType(Type interfaceType)
    {
        ...
        typeBuilder.BuildProperties(properties);
    ...
    private static void BuildProperties(this TypeBuilder typeBuilder, IEnumerable<PropertyInfo> properties)
    {
    ...
    private static PropertyBuilder BuildProperty(this TypeBuilder typeBuilder, PropertyInfo property)
    {
        ...
        var getterBuilder = typeBuilder.BuildGetter(property, fieldBuilder, getSetAttributes);
        var setterBuilder = typeBuilder.BuildSetter(property, fieldBuilder, getSetAttributes);
    ...
    private static MethodBuilder BuildGetter(this TypeBuilder typeBuilder, PropertyInfo property, FieldBuilder fieldBuilder, MethodAttributes attributes)
    {
    ...
    private static MethodBuilder BuildSetter(this TypeBuilder typeBuilder, PropertyInfo property, FieldBuilder fieldBuilder, MethodAttributes attributes)
    {
