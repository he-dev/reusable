...
public static class ResourceBuilderMethods
{
    ...
    public static Task<Response> ReadAsync<T>(this Request.Builder<T> builder, Action<T>? configure = default) where T : Request
    {
        return builder.InvokeAsync(Read, configure);
    }

    public static Task<Response> CreateAsync<T>(this Request.Builder<T> builder, Action<T>? configure = default) where T : Request
    {
        return builder.InvokeAsync(Create, configure);
    }

    public static Task<Response> UpdateAsync<T>(this Request.Builder<T> builder, Action<T>? configure = default) where T : Request
    {
        return builder.InvokeAsync(Update, configure);
    }

    public static Task<Response> DeleteAsync<T>(this Request.Builder<T> builder, Action<T>? configure = default) where T : Request
    {
        return builder.InvokeAsync(Delete, configure);
    }
