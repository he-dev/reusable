...
{
    public static RequestMethodBuilder.Read Read(this IResource resource) => new(resource);
    public static RequestMethodBuilder.Create Create(this IResource resource) => new(resource);
    public static RequestMethodBuilder.Update Update(this IResource resource) => new(resource);
    public static RequestMethodBuilder.Delete Delete(this IResource resource) => new(resource);
}