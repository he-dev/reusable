...
{
    public delegate ImmutableSessionSetter<T> ConfigureMetadataScopeCallback<T>(ImmutableSessionSetter<T> scope) where T : ISessionScope;
...
//        }
        ...
        /// </summary>
        [MustUseReturnValue]
        public static ImmutableSessionGetter<T> Scope<T>(this IImmutableSession metadata) where T : ISessionScope
        {
            var scope = metadata.TryGetValue(ImmutableSession<T>.Key, out IImmutableSession value)
                ? value
        ...
        /// </summary>
        [MustUseReturnValue]
        public static IImmutableSession Scope<T>(this IImmutableSession metadata, [NotNull] ConfigureMetadataScopeCallback<T> configureScope) where T : ISessionScope
        {
            ...
            var sessionSetter = configureScope(new ImmutableSessionSetter<T>(metadata.Scope<T>().Value));
            return metadata.SetItem(ImmutableSession<T>.Key, sessionSetter.Value);
        }
