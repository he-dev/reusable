...
namespace Reusable
{
    ...
    {
        private static readonly ConcurrentDictionary<Type, (BinaryExpression BinaryExpression, object Func)> Cache = new ConcurrentDictionary<Type, (BinaryExpression BinaryExpression, object Func)>();
