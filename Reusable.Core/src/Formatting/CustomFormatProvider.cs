...
namespace Reusable
{
    public abstract class CustomFormatProvider : IFormatProvider
    {
        ...
        protected CustomFormatProvider([NotNull] ICustomFormatter formatter) => _formatter = formatter ?? throw new ArgumentNullException(nameof(formatter));
    ...
    public class CompositeFormatProvider : IFormatProvider, IEnumerable<IFormatProvider>
    {
        ...
        public void Add([NotNull] Type formatProvider)
        {
        ...
        public void Add([NotNull] IFormatProvider formatProvider)
        {
            if (formatProvider == null) throw new ArgumentNullException(nameof(formatProvider));
