...
{
    [PublicAPI]
    public class StopwatchMock : IStopwatch, IDisposable
    {
        public StopwatchMock(params TimeSpan[] elapsedTimes)
        ...
        [NotNull]
        public static StopwatchMock StartNew(IEnumerable<TimeSpan> elapses)
        {
            var stopwatch = new StopwatchMock(elapses);
            stopwatch.Start();
            return stopwatch;
        }
