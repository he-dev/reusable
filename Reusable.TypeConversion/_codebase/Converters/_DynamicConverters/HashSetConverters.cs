...
{
    public class EnumerableObjectToHashSetObjectConverter : DynamicConverter<IEnumerable>
    {
    ...
    public class EnumerableObjectToHashSetStringConverter : DynamicConverter<IEnumerable>
    {
        public override bool TryConvert(ConversionContext context, object arg, out object instance)
        {
            if (context.Type.IsHashSet() && arg.GetType().IsEnumerable())
