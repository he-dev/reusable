...
{
    public class EnumerableObjectToArrayObjectConverter : DynamicConverter<IEnumerable>
    {
    ...
    public class EnumerableObjectToArrayStringConverter : DynamicConverter<IEnumerable>
    {
        public override bool TryConvert(ConversionContext context, object arg, out object instance)
        {
            if (context.Type.IsArray && arg.GetType().IsEnumerable())
