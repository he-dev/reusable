...
{
    public class DictionaryObjectObjectToDictionaryObjectObjectConverter : DynamicConverter<IDictionary>
    {
    ...
    public class DictionaryObjectObjectToDictionaryStringStringConverter : DynamicConverter<IDictionary>
    {
        public override bool TryConvert(ConversionContext context, object arg, out object instance)
        {
            var isValidType =
