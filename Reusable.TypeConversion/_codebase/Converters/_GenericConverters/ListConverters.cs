...
{
    public class EnumerableObjectToListObjectConverter : GenericConverter<IEnumerable>
    {
    ...
    public class EnumerableObjectToListStringConverter : GenericConverter<IEnumerable>
    {
        public override bool TryConvert(ConversionContext context, object arg, out object instance)
        {
