...
namespace Reusable.Converters
{
    public class DictionaryToDictionaryConverter : TypeConverter<IDictionary, object>
    {
        ...
        protected override object ConvertCore(IConversionContext<IDictionary> context)
        {
            ...
            {
                result.Add(
                    context.Converter.Convert(ConversionContext<object>.FromContext(key, keyType, context)),
                    context.Converter.Convert(ConversionContext<object>.FromContext(dictionary[key], valueType, context)));
            }
