...
namespace Reusable.Translucent
{
    public static class ResourceRepositoryExtensions
    {
        ...
        {
            return resources.InvokeAsync(Request.Create(RequestMethod.Post, uri, body, configureRequest));
        }
        ...
        {
            return resources.InvokeAsync(Request.Create(RequestMethod.Delete, uri, body, configureRequest));
        }
    }
}