...
namespace Reusable.OmniLog
{
    ...
    public static class LogFilter
    {
        ...
        [NotNull]
        public static LogPredicate NameMatches([NotNull] this LogPredicate logPredicate, [RegexPattern] string pattern, RegexOptions regexOptions = RegexOptions.IgnoreCase)
        {

            return log => logPredicate(log) && logPredicate.ValueMatches(l => l.Name()?.ToString() ?? string.Empty, pattern, regexOptions)(log);
        }
        ...
        [NotNull]
        public static LogPredicate ValueMatches([NotNull] this LogPredicate logPredicate, Func<Log, string> getValue, [RegexPattern] string pattern, RegexOptions regexOptions = RegexOptions.None)
        {
            if (logPredicate == null) throw new ArgumentNullException(nameof(logPredicate));
