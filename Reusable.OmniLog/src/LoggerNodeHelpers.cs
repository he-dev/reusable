...
namespace Reusable.OmniLog
{
    public static class LoggerNodeHelpers
    {
        ...
        public static LoggerFactory UseConstant(this LoggerFactory loggerFactory, params (string Name, object Value)[] constants) => loggerFactory.Use<ConstantNode>(n => n.Constants.AddRangeSafely(constants));
