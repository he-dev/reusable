...
namespace Reusable.OmniLog
{
    public static class LoggerNodeHelpers
    {
        ...
        public static LoggerFactoryBuilder UseFallback(this LoggerFactoryBuilder builder, params (string Name, object Value)[] defaults) => builder.Use<FallbackNode>(n => n.Properties.AddRangeSafely(defaults));
        public static LoggerFactoryBuilder UseFilter(this LoggerFactoryBuilder builder, Func<ILogEntry, bool> canLog) => builder.Use(new FilterNode { CanLog = canLog });
        ...
        public static LoggerFactoryBuilder UseService(this LoggerFactoryBuilder builder, params IPropertyService[] scalars) => builder.Use<PropertyNode>(n => n.Properties.AddRange(scalars));
