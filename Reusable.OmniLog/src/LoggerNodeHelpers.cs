...
namespace Reusable.OmniLog
{
    public static class LoggerNodeHelpers
    {
        ...
        public static LoggerFactoryBuilder UsePropertyMapper(this LoggerFactoryBuilder builder, params (SoftString From, string To)[] mappings) => builder.Use<PropertyMapperNode>(n => n.Mappings.AddRangeSafely(mappings));
