    ...
    public static class GenericValidation
    {
        ...
        public static IValidationContext<T> IsNull<T>(this IValidationContext<T> context, string message = null)
        {
            return context.Validate(
                ...
                message ?? "{MemberName:dq} must be null.".Format(new { context.MemberName }, FormatProvider));
        }
        ...
        public static IValidationContext<T> IsNotNull<T>(this IValidationContext<T> context, string message = null)
        {
            return context.Validate(
                value => !ReferenceEquals(value, null),
                message ?? "{MemberName:dq} must not be null.".Format(new { context.MemberName }, FormatProvider));
        }
            ...
            where T : IComparable
        {
            return context.Validate(
                ...
                message ?? "{MemberName:dq} must be less then {max:dq}.".Format(new { context.MemberName, max }, FormatProvider));
        }
            ...
            where T : IComparable
        {
            return context.Validate(
                value => value.CompareTo(max) <= 0,
                message ?? "{MemberName:dq} must be less then or equal {max:dq}.".Format(new { context.MemberName, max }, FormatProvider));
        }
            ...
            where T : IComparable
        {
            return context.Validate(
                ...
                message ?? "{MemberName:dq} must be greater then {min:dq}.".Format(new { context.MemberName, min }, FormatProvider));
        }
            ...
            where T : IComparable
        {
            return context.Validate(
                value => value.CompareTo(min) >= 0,
                message ?? "{MemberName:dq} must be greater or equal {min:dq.}".Format(new { context.MemberName, min }, FormatProvider));
        }
            ...
            where T : IComparable
        {
            return context.Validate(
                ...
                message ?? "{MemberName:dq}' must be between {min:dq} and {max:dq}.".Format(new { context.MemberName, min, max }, FormatProvider));
        }
            ...
            where T : IComparable
        {
            return context.Validate(
                value => value.CompareTo(min) >= 0 && value.CompareTo(max) <= 0,
                message ?? "{MemberName:dq}' must be between or equal {min:dq} and {max:dq}.".Format(new { context.MemberName, min, max }, FormatProvider));
        }
            ...
            where T : IComparable
        {
            return context.Validate(
                ...
                message ?? "{MemberName:dq} must be equal {equalValue:dq} but is {Value:dq}.".Format(new { context.MemberName, equalValue, context.Value }, FormatProvider));
        }
            ...
            where T : IComparable
        {
            return context.Validate(
                ...
                message ?? "{MemberName:dq} must not be equal {notEqualValue:dq}.".Format(new { context.MemberName, notEqualValue }, FormatProvider));
        }
        ...
        public static IValidationContext<T> IsTrue<T>(this IValidationContext<T> context, Func<T, bool> predicate, string message = null)
        {
            return context.Validate(
                ...
                message ?? "{MemberName:dq} must be {TrueString:dq}.".Format(new { context.MemberName, bool.TrueString }, FormatProvider));
        }
        ...
        public static IValidationContext<T> IsFalse<T>(this IValidationContext<T> context, Func<T, bool> predicate, string message = null)
        {
            return context.Validate(
                value => !predicate(value),
                message ?? "{MemberName:dq} must be {FalseString:dq}.".Format(new { context.MemberName, bool.FalseString }, FormatProvider));
        }
        ...
        public static IValidationContext<T> IsInstanceOfType<T>(this IValidationContext<T> context, Type type, string message = null)
        {
            return context.Validate(
                ...
                message ?? "{MemberName:dq} must be instance of {FullName:dq}.".Format(new { context.MemberName, type.FullName }, FormatProvider));
        }
    }    
}
