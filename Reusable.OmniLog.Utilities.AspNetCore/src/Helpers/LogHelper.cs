...
namespace Reusable.OmniLog.Utilities.AspNetCore.Helpers
{
    public static class LogHelper
    {
        ...
        {
            logger.Log(Execution.Context.Network().WorkItem(nameof(HttpRequest), new
            {
        ...
        {
            logger.Log(Execution.Context.Network().Meta(nameof(HttpResponse), new
            {
        ...
        {
            logger.Log(Execution.Context.Network().Meta(nameof(HttpRequest), "Faulted").Exception(exception));
        }
